...
const content = {
  ...
  bn: {
    ...
    hero: "আপনার Business এর জন্য AI Customer Service",
    heroDesc: "Automorai আপনার website, WhatsApp, Facebook — সব জায়গায় AI দিয়ে customer দের সাথে কথা বলে। আপনি ঘুমালেও business চলে।",
    getStarted: "Free তে শুরু করুন",
    demo: "Demo দেখুন →",
    ...
    steps: [
      { step: "১", title: "Signup করুন", desc: "Free তে account বানান" },
      { step: "২", title: "Connect করুন", desc: "WhatsApp ও Facebook connect করুন" },
      { step: "৩", title: "Widget বসান", desc: "Website এ script paste করুন" },
    ],
    pricingTitle: "Pricing",
    pricingDesc: "কোনো hidden charge নেই। যেকোনো সময় cancel করুন।",
    ctaTitle: "আজই শুরু করুন",
    ctaDesc: "Setup fee নেই। Credit card লাগবে না। ৫ মিনিটে ready।",
    ctaBtn: "Free তে শুরু করুন →",
    footer: "© 2026 Automorai. Built in Dhaka, Bangladesh.",
    features: [
      { icon: "💬", title: "Website Chat Widget", desc: "আপনার website এ AI chat bubble বসান — visitor রা সরাসরি chat করতে পারবে, AI instantly reply করবে।" },
      ...
      { icon: "📊", title: "Unified Inbox", desc: "WhatsApp, Messenger, Facebook, Website — সব conversation এক জায়গায় দেখুন।" },
      { icon: "🛒", title: "WooCommerce Integration", desc: "আপনার WooCommerce store এর product, দাম, stock automatically AI জানে।" },
    ],
    plans: [
      {
        name: "Starter",
